 ...
 */
class ProductModelAdvancedReader extends ProductModelReader implements InitializableInterface
{
    /**
            ...
            foreach ($attributesCodes as $attributesCode) {
                ...
                if (
                    ...
                    if ($isNewProduct === null) {
                        $isNewProduct = $this->productModelRepository->findOneByIdentifier($newItem[$this->identifierCode]) === null;
                    }
